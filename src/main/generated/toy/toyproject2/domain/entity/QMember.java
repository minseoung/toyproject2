...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = -1778406398L;
    ...
    public final ListPath<toy.toyproject2.domain.entity.item.Item, toy.toyproject2.domain.entity.item.QItem> items = this.<toy.toyproject2.domain.entity.item.Item, toy.toyproject2.domain.entity.item.QItem>createList("items", toy.toyproject2.domain.entity.item.Item.class, toy.toyproject2.domain.entity.item.QItem.class, PathInits.DIRECT2);
